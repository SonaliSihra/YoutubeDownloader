...
class App():
    ...
    def CreateUI(self, master):
        self.logo = ttk.Label(master, text="Youtube Downloader", font=("calibre", 16))
        ...
        self.urlL = ttk.Label(getUrlLs, text="Youtube Url", font=("calibre", 12))
        ...
        self.formL = ttk.Label(getForm, text="Video Format", font=("calibre", 12))
        ...
        ttk.Label(text="Download location", font=("calibre", 12)).pack(side="top", anchor="w")
        ...
        Public.logger.config(height=20, state="disabled")
        ...
        self.downloadB = ttk.Button(master, text="Download", command=lambda: self.Download(master))
